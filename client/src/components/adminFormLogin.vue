        ...
        <div class="login-form">
            ...
            <form @submit.prevent="submitLogin">
                ...
                <div>
                    ...
                    <input type="tel" id="dienThoai" v-model="loginData.DIENTHOAI" required pattern="[0-9]{10}"
...
export default {
    ...
    methods: {
        async submitLogin() {
            try {
                const response = await axios.post('http://localhost:3000/api/nhanvien/login', this.loginData);
